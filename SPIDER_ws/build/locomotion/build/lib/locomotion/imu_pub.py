...
class SpiderIMUPublisher(Node):
    ...
    def __init__(self):
        ...
        self.sensor = ServoLeveler(0x39, self.simBool)
    ...
    def timer_callback(self):
        ...
        self.logImuData(tempQuatTuple, tempAngTuple, tempAccTuple, currTime.seconds_nanoseconds())
        self.i += 1

    def logImuData(self, quatTuple, angTuple, accTuple, currTime):
        ...
        self.get_logger().info(self.convertTuple(quatTuple))
