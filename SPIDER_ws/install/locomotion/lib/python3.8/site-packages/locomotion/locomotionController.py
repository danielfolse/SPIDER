...
class LocomotionController:
    def __init__(self, addressLA, addressLB, addressRA, addressRB, addressSL, simDriver, simSensor, graph):
        ...
        self.angles = [[[[90,90,90,80,85,95,100],[135,170,170],[120,90,90]],  #   LA    1   H V E
                        [[90,90,90,80,85,95,100],[140,175,180],[115,90,90]]], #   LA    2   H V E
                       [[[90,90,90,80,85,95,100],[125,165,160],[125,90,90]],  #   LB    3   H V E
                        [[90,90,90,80,85,95,100],[140,170,170],[120,90,90]]], #   LB    4   H V E
                       [[[90,90,90,80,85,95,100],[45,10,15], [60,90,90]],     #   RA    1   H V E
    ...
    def setUpAnglesLeg(self, numSteps, leg, horizAngle, distance):
        ...
        for i in range(len(horiz_angles)):
            if (leg == 0): # left 1
                ...
                self.forward_angles[leg, 2, i] = self.angles[LA][L1][E][STOP] + (180 + vert_angles[i] + 90 - 15 - elb_angles[i]) - 55
            elif (leg == 1): # right 1
                ...
                self.forward_angles[leg, 2, i] = self.angles[LA][L2][E][STOP] + (180 + vert_angles[i] + 90 - 15 - elb_angles[i])  - 55
            elif (leg == 3): # right 2
                self.forward_angles[leg, 0, i] = 90 - horiz_angles[i]  
                ...
                self.forward_angles[leg, 2, i] = self.angles[LB][L3][E][STOP] + (180 + vert_angles[i] + 90 - 15 - elb_angles[i])  - 50
            elif (leg == 5): # right 3
                ...
                self.forward_angles[leg, 2, i] = self.angles[LB][L4][E][STOP] + (180 + vert_angles[i] + 90 - 15 - elb_angles[i])  - 50
            elif (leg == 7): # right 4
    ...
    def checkRotationPose(self, goal_angle):
        ...
        return self.convertSensorReading(heading, goal_angle)
